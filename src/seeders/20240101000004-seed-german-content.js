...
module.exports = {
    async up(queryInterface, Sequelize) {
        // Sample German questions with JSONB format
        const germanQuestions = [{
                ...
                correct_option: 0,
                explanation: {
                    "en": "In residential areas, the speed limit is 30 km/h to ensure pedestrian safety.",
            ...
            },
            {
                ...
                options: {
                    "en": ["Stop", "Slow down", "Drive with caution", "Yield"],
                    "de": ["Anhalten", "Verlangsamen", "Mit Vorsicht fahren", "Vorfahrt gewähren"]
                },
                correct_option: 0,
                explanation: {
                    "en": "A red traffic light means you must come to a complete stop before the stop line.",
            ...
            },
            {
                ...
                options: {
                    "en": ["Stop if possible", "Accelerate", "Continue at same speed", "Yield to pedestrians"],
        ...
        // Sample German quotes with JSONB format
        const germanQuotes = [{
                text: {
